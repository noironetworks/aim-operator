...
- admissionReviewVersions:
  ...
  clientConfig:
    caBundle: ${CA_BUNDLE}
    url: https://${CRC_IP}:9443/validate-ciscoaciaim-openstack-org-v1beta1-ciscoaciaim
  failurePolicy: Fail
...
- admissionReviewVersions:
  ...
  clientConfig:
    caBundle: ${CA_BUNDLE}
    url: https://${CRC_IP}:9443/mutate-ciscoaciaim-openstack-org-v1beta1-ciscoaciaim
  failurePolicy: Fail
  matchPolicy: Equivalent
  name: mciscoaciaim.kb.io
  objectSelector: {}
...
CSV_NAME="$(oc get csv -n openstack-operators -l operators.coreos.com/ciscoaciaim-operator.openstack-operators -o name)"
